...
When a client has lost their license due to nonpayment of forfeitures, there are several options.
  ...
  **4. Allow the suspension to expire.** Sometimes, a client has a suspension due to failure to pay forfeitures that has already expired. In this case, the only barrier to recovering a driver’s license is paying the DMV’s $60 license fee. 

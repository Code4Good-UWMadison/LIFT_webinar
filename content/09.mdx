...
**Second, they could seek a payment plan to pay off the forfeiture over time.**

**Third, they could seek a modification of the judgment, such as a permanent stay, based on a poverty hearing.** A request other than a payment plan requires that the client include an affidavit and justification for the request. We will be learning more about payment plans and asserting poverty soon––these are paths that often require a client to have the continued assistance of a volunteer lawyer like you.

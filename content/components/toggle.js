...
const items = [
    {
        ...
        content: "<b>Failure to Pay Forfeiture (FPF) suspensions</b> are one-year suspensions for failure to pay a traffic ticket. This is the most common suspension, accounting for 59% of all suspensions in 2018. It is also the most frequent suspension among our clinic clients. Sometimes it is accompanied by additional suspensions and other types of suspensions.",
    },
    {
        uuid: 2,
        heading: "Driving Record Suspensions",
        content: "Another common suspension is the <b>Driving Record (DR) or “points,” suspension</b> This occurs when a driver accrues 12 or more points in any twelve-month period. The length of the suspension depends upon the total number of points the driver has and the type of license they hold.        ",
    },
    {
        uuid: 3,
    ...
    },
    {
        ...
        content: "A <b>Failure to Complete Course (FCC) suspension</b> occurs when an individual fails to complete the Right of Way Course that is required after certain violations. This suspension can be for up to five years.        ",
    },
    {
        uuid: 6,
        heading: "Failure to Pay Support",
        content: "A <b>Failure to Pay Support (FPS) suspension</b> is due to a person’s failure to pay child support. These suspensions can last up to two years when court-imposed and up to five years when imposed by the Department of Workforce Development.",
    },
    {
        uuid: 7,
        heading: "Safety Responsibility Suspensions",
        content: "A <b>Safety Responsibility (SR) suspension</b> is due to an uninsured accident, with damages greater than $1,000, where a driver fails to provide proof of insurance, to post a bond, or to prove a lack of fault for the accident. The length may be listed as indefinite, but it is actually one year. SR-22 insurance is required for three years from the end of the suspension.        ",
    },
    {
        uuid: 8,
        heading: "Damage Judgment Suspension",
        content: "A <b>Damage Judgment (DJN) suspension</b> is a suspension due to damages greater than $500 from an uninsured accident where the individual was found liable in court. The suspension begins on the date of the court judgment. SR-22 insurance is required for 3 years from the end of the suspension.        ",
    },
    {
        uuid: 9,
        heading: "Habitual Traffic Offender Revocation",
        content: "An <b>Habitual Traffic Offender (HTO) revocation</b> is a revocation for four major violations or 12 minor violations in a five-year period. The length of the revocation is five years, but an occupational license can be granted through a court order after two years of the revocation. SR-22 insurance is required for three years from the end of the revocation.        ",
    },
    {
        uuid: 10,
        heading: "Operating While Intoxicated Revocations",
        content: "An <b>Operating While Intoxicated (OWI) revocation</b> occurs for different lengths of time based upon the number of previous OWI tickets the individual has received.        ",
    },
    {
        uuid: 11,
        heading: "Blood Alcohol Content Suspension",
        content: "A <b>Blood Alcohol Content (BAC) suspension </b> is an administrative suspension imposed by the DMV for a period of six months when a chemical test result is at least .08 after an OWI arrest.        ",
    },
    {
        uuid: 12,
